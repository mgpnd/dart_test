...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Interceptor: {
      ...
      "%": "AnimationEvent|AnimationPlayerEvent|ApplicationCacheErrorEvent|ArrayBuffer|AudioProcessingEvent|AutocompleteErrorEvent|BeforeInstallPromptEvent|BeforeUnloadEvent|BlobEvent|ClipboardEvent|CloseEvent|CompositionEvent|CustomEvent|DOMError|DeviceLightEvent|DeviceMotionEvent|DeviceOrientationEvent|DragEvent|ErrorEvent|Event|ExtendableEvent|ExtendableMessageEvent|FetchEvent|FileError|FocusEvent|FontFaceSetLoadEvent|GamepadEvent|GeofencingEvent|HashChangeEvent|IDBVersionChangeEvent|InputEvent|InstallEvent|KeyboardEvent|MIDIConnectionEvent|MIDIMessageEvent|MediaEncryptedEvent|MediaError|MediaKeyMessageEvent|MediaQueryListEvent|MediaStreamEvent|MediaStreamTrackEvent|MessageEvent|MouseEvent|Navigator|NavigatorUserMediaError|NotificationEvent|OfflineAudioCompletionEvent|PageTransitionEvent|PointerEvent|PopStateEvent|PositionError|PresentationConnectionAvailableEvent|PresentationConnectionCloseEvent|ProgressEvent|PromiseRejectionEvent|PushEvent|RTCDTMFToneChangeEvent|RTCDataChannelEvent|RTCIceCandidateEvent|RTCPeerConnectionIceEvent|RelatedEvent|ResourceProgressEvent|SQLError|SVGAnimatedLength|SVGZoomEvent|SecurityPolicyViolationEvent|ServicePortConnectEvent|ServiceWorkerMessageEvent|SpeechRecognitionError|SpeechRecognitionEvent|SpeechSynthesisEvent|StorageEvent|SyncEvent|TextEvent|TouchEvent|TrackEvent|TransitionEvent|UIEvent|USBConnectionEvent|WebGLContextEvent|WebKitTransitionEvent|WheelEvent"
    },
    JSBool: {
      "^": "Interceptor;",
    ...
    main: function() {
      ...
      if (typeof console != "undefined")
        console.log(btn);
      J._addEventListener$3$x(btn, "click", F.application__updateHeader$closure(), null);
    },
    updateHeader: [function(e) {
      var header, postion_el, pos, t1, exception;
      t1 = document;
      header = t1.querySelector("#header");
      try {
        postion_el = t1.querySelector("#position");
        pos = J.getBoundingClientRect$0$x(header);
        J.set$text$x(postion_el, "Header position | left: " + H.S(J.get$left$x(pos)) + ", right: " + H.S(J.get$right$x(pos)));
        J.set$text$x(header, "Another Header");
      } catch (exception) {
        H.unwrapException(exception);
        J.set$text$x(header, "Error! Open console to get details.");
        throw exception;
      }
    }, "call$1", "application__updateHeader$closure", 2, 0, 0]
  }, 1]];
  setupProgram(dart, 0);
